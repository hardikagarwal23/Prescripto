        ...
        <div className="flex flex-col gap-4 m-5">
          ...
          <div className="flex-1 border border-stone-200 rounded-lg p-8 py-7 bg-white">
            ...
            <div>
              ...
              <p className="text-gray-600 max-w-[700px] mt-1">{profileData.about}</p>
            </div>
            ...
            {isEdit ?
              <button onClick={() => updateProfile()} className="px-4 py-1 border border-primary rounded-full mt-5 hover:bg-primary hover:text-white transition-all ">Save Information</button>
